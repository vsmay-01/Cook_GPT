...
const EmptyPage = () => {
  ...
  return (
    <div className="flex items-center justify-center py-8 px-4 w-full">
      {isSignedIn && user && (
        <div className="bg-[#242424] rounded-xl shadow-lg p-6 max-w-md w-full border border-gray-700">
          ...
          <div className="space-y-5">
            <h4 className="text-lg font-semibold text-gray-200 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#ff8c42]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ol className="space-y-4">
              <li className="flex items-start">
                <span className="flex-shrink-0 w-7 h-7 bg-gradient-to-br from-[#ff8c42] to-[#ff6b2b] rounded-full flex items-center justify-center mr-3 text-sm font-bold text-white shadow-md">
                  1
                </span>
                <div>
          ...
          {/* Quick tip */}
          <div className="mt-6 bg-[#1c1c1c] rounded-lg p-3 border border-gray-700">
            <div className="flex items-center text-[#ff8c42] font-medium">
